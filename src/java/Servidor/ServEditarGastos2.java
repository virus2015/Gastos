 ...
 * @author jorge.lopez
 */
@WebServlet(name = "ServEditarGastos2", urlPatterns = {"/ServEditarGastos2"})
public class ServEditarGastos2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         int idArticulos = Integer.parseInt(request.getParameter("idArticulos"));
            ...
            int id = Integer.parseInt(request.getParameter("idgastos"));
            
            GastosN gn = new GastosN();
            GastosD gd = new GastosD();
            
            gd.setIdArticulos(idArticulos);
            gd.setIdCategorias(idCategorias);
            gd.setIdTiendas(idTiendas);            
            ...
            response.sendRedirect("GastosFijos.jsp");
