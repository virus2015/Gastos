...
<html>
    ...
    <section id ="seccion">
         ...
         <article>
            ...
            <form action ="/Gastos/ServInsertarGastos3" method ="POST">
                <fieldset>
             ...
             <select name ="idCategorias" >
                 ...
                 ArrayList <CategoriasD> cad = can.consultarTodosGFV();
             ...
             <select name ="idArticulos" >
                ...
                <%
                 ...
                 ArrayList <ArticulosD> ard = ar.ListarTodosGV();
                ...
                <select name="idTiendas" >
                    ...
                    ArrayList <TiendasD> ti = tin.selecAllTiendasA3();
...
%>
                ...
                <label>Fecha FALTAAAAA COMBO BOX POR RANGOS DE MES</label><br>
       ...
       <fieldset>
        ...
        String sql =" select gg.IDGASTOS as id,gg.cantidad as cantidad, "
                ...
                + "    inner join categoriasg2 cg     on cg.idcategorias= gg.frk_idcategorias  "
                + "   inner join tiendasg2 tt         on tt.idTiendas = gg.frk_idTiendas   "
                + " where gg.fecha between '01/09/2019' and '30/09/2019'  AND cg.frk_idgastosfijos=3  ";
               ...
               <td><%=resultado.getString("producto")  %></td>
                ...
                <td><%=resultado.getString("monto")  %></td>
                 ...
                 <td><%=resultado.getString("categoria")  %></td>  
                    ...
                    <td><A href="/Gastos/ServEliminarGastos3?id=<%=resultado.getString("id") %>">ELIMINAR</A></td>
                    <td><A href="EditarGastos3.jsp?id=<%=resultado.getString("id")  %>">EDITAR</A></td>
