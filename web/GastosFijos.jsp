...
<html>
    ...
    <section id ="seccion">
         ...
         <article>
            ...
            <form action ="/Gastos/ServInsertarGastos2" method ="POST">
                <fieldset>
             ...
             <select name ="idArticulos" >
                ...
                <select name="idTiendas" >
                    ...
                    ArrayList <TiendasD> ti = tin.selecAllTiendasA1();
...
%>
     ...
     String sql =" select gg.IDGASTOS as id,gg.cantidad as cantidad, "
                ...
                + " where gg.fecha between '01/09/2019' and '30/09/2019'  AND cg.frk_idgastosfijos=1  "; 
               ...
               <td><%=resultado.getString("producto")  %></td>
                ...
                <td><%=resultado.getString("monto")  %></td>
                 ...
                 <td><%=resultado.getString("categoria")  %></td>  
                    ...
                    <td><A href="/Gastos/ServEliminarGastos2?id=<%=resultado.getString("id") %>">ELIMINAR</A></td>
                    <td><A href="EditarGastos2.jsp?id=<%=resultado.getString("id")  %>">EDITAR</A></td>
